for i in 1 2 3 4 5
do
python mailme.py --message "Starting with Ring"   
python run.py \
    ...
    --n_mpi_process 4 --n_sub_process 1 --world 0,0,0,0 --on_cuda False --use_ipc False --comm_device cpu \
...
python mailme.py --message "Done with Ring"
    ######################
...
python mailme.py --message "Done with Torus"
########
